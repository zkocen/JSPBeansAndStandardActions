...
public class Country implements Serializable {
	...
	public String toString() {
		return String
				.format("Code: %s\tName: %s\tContinent: %s\tRegion%s\t "
						...
						getCode(), getName(), getContinent(), getRegion(),
						getSurfaceArea(), getIndepYear(), getPopulation(),
						getLifeExpectancy(), getGnp(), getGnpOld(),
						getLocalName(), getGovernmentForm(), getHeadOfState(),
						getCapital(), getCode2());
	}
}
